...
class Processor():
    ...
    def train(self, epoch, save_model=False):
        ...
        loss_value = []
        self.train_writer.add_scalar('epoch', epoch, epoch)
        self.record_time()
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            ...
            # loss_value.append(loss.data[0])   lifanjia
            loss_value.append(loss.item())
            # print('loss_value',loss_value)
            timer['model'] += self.split_time()
            # print('data.shape',output.shape)
            # print('data.shape', loss)
        ...
        self.train_writer.add_scalar('acc', acc, epoch)
        self.train_writer.add_scalar('loss', loss.item(), epoch)
        self.train_writer.add_scalar('loss_l1', l1, epoch)
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            if self.arg.phase == 'train':
                ...
                self.val_writer.add_scalar('loss_l1', l1, epoch)
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            for epoch in range(self.arg.start_epoch, self.arg.num_epoch):
                ...
                save_model = (epoch % self.arg.save_interval == 0) or (
